(function () {
    ...
    function navBar() {
        var directive = {
            restrict: 'A',
            templateUrl: 'app/ZAFW/navBar/navBar2/navBar2.html',
            //scope:{
            //    searchInput:'@'
            //},
        ...
        /** @ngInject */
        function NavbarController($scope, $state, mmpadminAPI, alertbox, $stateParams, apiSetting2) {
            ...
            pageFunc.getApiAll = function () {
                apiSetting2.getApiAll(function (data) {
            ...
            pageFunc.myKeyup = function (e) {
                ...
                apiSetting2.getapiPram(searchValue, function (data) {
